...
const { data } = await useLazyFetch<{ stargazers_count: number }>(
  "https://api.github.com/repos/status-base/statusbase-supabase",
  {
...
<template>
  <a
    ...
    href="https://github.com/status-base/statusbase-supabase"
    target="_blank"
    aria-label="Star status-base/statusbase on GitHub"
  >
